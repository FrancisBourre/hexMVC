 ...
 */
class MockParallelNonAtomicMacroCommandFailing extends MacroCommand<String>
{
	static public var executionCount 	: UInt = 0;
	static public var command			: MockParallelNonAtomicMacroCommandFailing;
	...
	override function _prepare():Void 
	{
		...
		MockParallelNonAtomicMacroCommandFailing.executionCount++;
		MockParallelNonAtomicMacroCommandFailing.command = this;
