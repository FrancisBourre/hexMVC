 ...
 */
class MockParallelMacroCommandCancel extends MacroCommand<String>
{
	static public var executionCount 	: UInt = 0;
	static public var command			: MockParallelMacroCommandCancel;
	...
	override function _prepare():Void 
	{
		...
		MockParallelMacroCommandCancel.executionCount++;
		MockParallelMacroCommandCancel.command = this;
